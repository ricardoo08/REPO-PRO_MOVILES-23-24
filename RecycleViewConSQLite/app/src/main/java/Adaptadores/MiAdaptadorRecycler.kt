...
import Modelo.Almacen.personas
...
class MiAdaptadorRecycler(var personajes : ArrayList<Persona>, var  context: Context) : RecyclerView.Adapter<MiAdaptadorRecycler.ViewHolder>(){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val nombrePersonaje = view.findViewById(R.id.txtNombre) as TextView
        val tipoPersonaje = view.findViewById(R.id.txtNacion) as TextView
        val avatar = view.findViewById(R.id.imgImagen) as ImageView
        ...
        fun bind(pers: Persona, context: Context, pos: Int, miAdaptadorRecycler: MiAdaptadorRecycler){
            ...
            tipoPersonaje.text = pers.nacionalidad
...
//            }
            ...
            itemView.setOnClickListener {
                if (pos == MiAdaptadorRecycler.seleccionado){
                    ...
                    Log.e("ACSC0", "Seleccionado: ${Almacen.personas.get(MiAdaptadorRecycler.seleccionado).toString()}")
                }
...
//                context.startActivity(intent)
            ...
            itemView.setOnLongClickListener(View.OnLongClickListener {
                Log.e("ACSCO","Seleccionado con long click: ${Almacen.personas.get(pos).toString()}")
                Almacen.personas.removeAt(pos)
                miAdaptadorRecycler.notifyDataSetChanged()
